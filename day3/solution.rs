...
Your tasks:
1.  Yank the line with the comment "// TASK 1" and put it below the line with the comment "// TASK 2".
2.  In the line with the comment "// TASK 3", yank the word "Rust" and put it at the end of the line.
*/
